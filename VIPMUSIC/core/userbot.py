...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("CRAZY_OP_01")
                await self.one.join_chat("CRAZY_OP_01")
                await self.one.join_chat("CRAZY_OP_01")
                await self.one.join_chat("CRAZY_OP_01")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("CRAZY_OP_01")
                await self.two.join_chat("CRAZY_OP_01")
                await self.two.join_chat("CRAZY_OP_01")
                await self.two.join_chat("CRAZY_OP_01")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("CRAZY_OP_01")
                await self.three.join_chat("CRAZY_OP_01")
                await self.three.join_chat("CRAZY_OP_01")
                await self.three.join_chat("CRAZY_OP_01")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("CRAZY_OP_01")
                await self.four.join_chat("CRAZY_OP_01")
                await self.four.join_chat("CRAZY_OP_01")
                await self.four.join_chat("CRAZY_OP_01")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("CRAZY_OP_01")
                await self.five.join_chat("CRAZY_OP_01")
                await self.five.join_chat("CRAZY_OP_01")
                await self.five.join_chat("CRAZY_OP_01")
            except:
